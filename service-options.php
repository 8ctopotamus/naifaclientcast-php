<?php
	...
	if($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$email_body = $email_body . "Designations: " . $designations . "<br>";
		...
		$email_body = $email_body . "Desired URL: " . $desiredURL . "<br>";
		...
		/*
		 * Send autoresponse email to Registrant
		 */
		$autoresponseMail = new PHPMailer();

		if ( !$autoresponseMail->ValidateAddress($email) ) {
			echo "You must specify a valid email address.";
			exit;
		}
		...
		//Email Body
		$email_body2 = "";
		$email_body2 = "<strong>Thank you for upgrading to Premier Membership!</strong>" . "<br>";
		$email_body2 = $email_body2 . "To finish your enrollment, please call 877-825-7579 or email <a href=\"mailto:info@naifaclientcast.com\">info@naifaclientcast.com</a> to schedule a call. <br><br>";
		$email_body2 = $email_body2 ."- The NAIFA ClientCast&reg; Team";

		$autoresponseMail->SetFrom('info@naifaclientcast.com', 'NAIFA ClientCast');

		// send to email address supplied in form
		$autoresponseMail->AddAddress($email, "NAIFA ClientCast");
		$autoresponseMail->Subject = "Thank You for Upgrading | NAIFA ClientCast";
		$autoresponseMail->MsgHTML($email_body2);

		if(!$autoresponseMail->Send()) {
		  echo "There was a problem sending the autoresponse email: " . $registrantAddress->ErrorInfo;
		  exit;
		}

		//redirect after all emails sent
		header('Location: service-options.php?status=thanks');
		exit;
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
			    ...
			    <div class="well text-left">
					...
					<ul>
<li>Option to have all emails and social posts sent FOR YOU.</li>
	...
	<div class="row text-center">
		<p class="lead">Premier Service retails for $300/month with a $250 one-time setup fee. With your NAIFA membership, you are eligible for a significant discount!</p>

		<p>Monthly: $99 setup fee, plus $50/month<br> <small>Concentrates on insurance-related topics</small></p>

		<p>Weekly: $99 setup fee, plus $60/month<br><small>Discusses insurance and securities-related topics</small></p>
	</div>
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title" id="upgradeModalLabel">Upgrade to Premier Service</h4>
	      </div>
	      <div class="modal-body">


					<script type='text/javascript' src='https://ou290.infusionsoft.com/app/form/iframe/982893b57ce440ea85589e0b1e5e2eaa'></script>



	   		<!-- <form action="service-options.php" method="post">
	      <div class="form-group">
				...
				<div class="form-group">
					<label for="designations">Designation(s)</label>
					<input type="text" class="form-control" id="designations" name="designations" placeholder="e.g. LUTCF, ChFC...">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="phone" name="phone" placeholder="(555) 555-5555" required />
				</div>
				<div class="form-group">
				...
				<div class="form-group">
				    <label for="desiredURL">Desired URL</label>
				    <div class="input-group">
				      <div class="input-group-addon">http://RealWealthMedia.com/</div>
				      <input type="text" class="form-control" name="desiredURL" id="desiredURL" placeholder="JoeSmith">
				    </div>
				    <small>Ex: http://RealWealthMedia.com/<strong>JoeSmith</strong></small><br>
				    <small>Or http://RealWealthMedia.com/<strong>SmithFinancial</strong></small>
				</div>
